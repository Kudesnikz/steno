...
*   **Локальная транскрибация:** Использование Apple Speech (`SFSpeechRecognizer`) для мгновенного получения текста встречи прямо во время записи без отправки аудио в облако.
