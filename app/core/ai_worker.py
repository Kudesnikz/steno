    ...
    def run(self):
        ...
        try:
            ...
            user_prompt = (
                ...
                "Если тебе необходимо указывать имена участников - проверь правильность их написания в разных частях видео. Очень важно чтоб имена были корректными. Ответ без дополнительных комментариев."
            )
